...
<div class="modal-body">
    ...
    <div class="row">
        <div class="col-md-2">
            ...
            <div class="progress">
                <div class="progress-bar progress-bar-striped" id="new-blue-bg" role="progressbar" aria-valuenow="{{ (int)$task->progress }}" aria-valuemin="0" aria-valuemax="100" style="width:{{ (int)$task->progress }}%"></div>
            </div>
        </div>
        <div class="col-md-7">
