            ...
            $("#createEventForm").submit(function (e) {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        // $('#createEventForm .project_id').selectpicker('deselectAll');
                        $('#createEventForm .user_id').selectpicker('deselectAll');
                        // $('#createEventForm .event_type').selectpicker('deselectAll');
                        $('#createEventForm .days_of_week').selectpicker('deselectAll');
