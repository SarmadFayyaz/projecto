...
@section('title', __('header.permissions'))
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var table = $('.yajra_datatable').DataTable({
                ...
                ajax: "{{ route('admin.permission.get') }}",
                columns: [
            ...
            $(document).on('click', '.remove', function () {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $('#delete_form').attr('action', APP_URL + '/admin/permission/' + id);
                        $('#delete_form').submit();
                    }
                })
            });
