            ...
            <li class="adjustments-line">
                <a href="javascript:void(0)" class="switch-trigger active-color">
                    <div class="badge-colors ml-auto mr-auto">
                        <span class="badge filter {{ (isset(Auth::guard('admin')->user()->background) && Auth::guard('admin')->user()->background == 'primary') ? 'active' : '' }} badge-purple" data-color="primary"></span>
                        ...
                        <span class="badge filter {{ (isset(Auth::guard('admin')->user()->background) && Auth::guard('admin')->user()->background == 'warning') ? 'active' : '' }} badge-warning" data-color="warning"></span>
            ...
            <li class="adjustments-line">
                <a href="javascript:void(0)" class="switch-trigger background-color">
                    <div class="ml-auto mr-auto">
                        <span class="badge filter {{ (isset(Auth::guard('admin')->user()->sidebar_background) && Auth::guard('admin')->user()->sidebar_background == 'black') ? 'active' : '' }} badge-black" data-background-color="black"></span>
                        <span class="badge filter {{ (isset(Auth::guard('admin')->user()->sidebar_background) && Auth::guard('admin')->user()->sidebar_background == 'white') ? 'active' : '' }} badge-white" data-background-color="white"></span>
                        <span class="badge filter {{ (isset(Auth::guard('admin')->user()->sidebar_background) && Auth::guard('admin')->user()->sidebar_background == 'red') ? 'active' : '' }} badge-red" data-background-color="red"></span>
                    </div>
                    <div class="clearfix"></div>
                </a>
            </li>
