...
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>{{(App::setLocale(Session('locale')))}}<title>
    {{ __('header.method_o') }} </title>
<meta content='width=device-width, initial-scale=1.0, shrink-to-fit=no' name='viewport'/><!--     Fonts and icons     -->
